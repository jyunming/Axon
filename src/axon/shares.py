...
def redeem_share_key(
    ...
    On Linux a ``ShareMount/`` symlink is also created for transitional
    compatibility; it is skipped silently on other platforms.
    ...
    Returns:
        Dict with: mount_name, mount_path, owner, project, descriptor.
    ...
    # ── Primary: create descriptor in mounts/ (platform-independent) ─────────
    ...
    # ── Transitional: create ShareMount/ symlink on Linux only ───────────────
    ...
    try:
        ...
        pass  # Non-Linux or permission issue — descriptor is sufficient
