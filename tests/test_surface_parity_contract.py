...
class TestVsCodeManifestContract:
    ...
    def test_tier1_vscode_capabilities_in_manifest(self):
        ...
        # Map capability id to expected tool name (convention: axon_<camelCase>)
        _CAP_TO_TOOL = {
            "query": "axon_queryKnowledge",
            "search": "axon_searchKnowledge",
            "ingest_text": "axon_ingestText",
            "ingest_url": "axon_ingestUrl",
            "ingest_path": "axon_ingestPath",
            "ingest_refresh": "axon_refreshIngest",
            "ingest_stale": "axon_listStaleDocs",
            "collection_inspect": "axon_getCollection",
            "collection_delete": "axon_deleteDocuments",
            "collection_clear": "axon_clearCollection",
            "project_list": "axon_listProjects",
            "project_switch": "axon_switchProject",
            "project_create": "axon_createProject",
            "project_delete": "axon_deleteProject",
            "config_update": "axon_updateSettings",
            "store_init": "axon_initStore",
            "share_generate": "axon_shareProject",
            "share_redeem": "axon_redeemShare",
